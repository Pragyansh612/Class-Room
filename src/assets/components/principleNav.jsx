        ...
        <div>
            ...
            <nav className='h-16 bg-emerald-500 flex justify-between items-center text-white'>
                ...
                <ul className='flex mx-5 gap-5 text-lg'>
                    <li><Link to="" className='hover:font-bold duration-150'>Teachers</Link></li>
                    <li><Link to="" className='hover:font-bold duration-150'>Students</Link></li>
                    <li><Link to="" className='hover:font-bold duration-150'>Classrooms</Link></li>
                    <li><Link to="/principle/create" className='hover:font-bold duration-150'>Create</Link></li>
                </ul>
            </nav>
        </div>
    )
